...
def verify(run):
 spec=load(ROOT/'experiments/CLASSICAL-SCHEDULES-0001.json');manifest=load(run/'manifest.json');public=load(run/'public-cases.json');private=load(run/'controller-private.json');attack=load(run/'attacker-output.json');reveal=load(run/'seed-reveal.json')
