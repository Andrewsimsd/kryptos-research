...
SPEC=ROOT/'experiments/CLASSICAL-SCHEDULES-K4-0002.json'
...
def main():
 ...
 verify=subprocess.run([sys.executable,ROOT/'verification/verify_classical_k4_v2.py',run],cwd=ROOT,capture_output=True,text=True);(run/'verification.stderr').write_text(verify.stderr)
