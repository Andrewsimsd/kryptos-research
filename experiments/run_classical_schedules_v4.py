...
SPEC=ROOT/'experiments/CLASSICAL-SCHEDULES-0004.json'
...
def main():
 ...
 verify=subprocess.run([sys.executable,ROOT/'verification/verify_classical_schedules_v4.py',run],cwd=ROOT,capture_output=True,text=True)
